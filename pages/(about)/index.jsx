  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="rounded glass px-3 sm:px-4 py-3 border border-gray-200 relative my-5"
          data-aos="fade-right"
        >
          <h2
          ...
          >
            ...
            in HTML, CSS, JavaScript, Git, Tailwind, Bootstrap, SCSS, React,
            Node Express, Mongodb, Redux, MySQL, Django and Flask. I excel in
        ...
        <div
          data-aos="fade-left"
          className={`${styles.skills} flex flex-col items-center rounded glass px-3 sm:px-4 py-3 z-10 border border-gray-200 relative my-5`}
        >
